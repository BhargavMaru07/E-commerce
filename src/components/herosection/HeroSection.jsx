  ...
  return (
    <div className="w-full relative  cursor-pointer group overflow-hidden">
      ...
      <img
        ...
        className="2xl:h-[380px] object-coverp object-center w-full absolute top-0 left-0 opacity-0 translate-x-full group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-600 ease-in"
      />
    </div>
  );
}
